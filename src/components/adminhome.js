    ...
    <div className="admin-home">
      ...
      <div className="dashboard">
        ...
        <ul>
          ...
          <li>
            <a href="#manageArtworks" onClick={() => handleNavClick('manage-artworks')}>
              MANAGE ARTWORKS
            </a>
          </li>
          <li>
            <a href="#Adminsettings" onClick={() => handleNavClick('settings')}>
              SETTINGS
            </a>
          </li>
          <li>
      ...
      <div className="main-frame">
        ...
        <div className={`sction ${activeSection === 'manage-artworks' ? 'active' : ''}`}>
